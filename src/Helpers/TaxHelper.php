...
namespace Ryu\Seat\Tax\Helpers;
...
trait TaxHelper
{
     ...
     * @param $year
     * @param $month
     * @return CorporationBill[]|\Illuminate\Database\Eloquent\Builder[]|\Illuminate\Database\Eloquent\Collection
     */
    ...
    {
        return CorpBillModel::where("corporation_id", $corporation_id)
            ->where("month", $month)
            ->where("year", $year)
            ->get();
    }
